...
namespace ElarosProject.View
{
	...
	public partial class AchesSeverity : ContentPage
	{
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                AssessmentModel symptom = new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Aches/Pains").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy"));
