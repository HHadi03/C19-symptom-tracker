...
namespace ElarosProject.View
{
	...
	public partial class AchesSeverity : ContentPage
	{
        ...
        public AchesSeverity ()
		{
			InitializeComponent ();
            inputValidatedTaskCompleted = new TaskCompletionSource<bool>();
        }
        private void AchesPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                _assessmentVM.AssessmentResults.Add(new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Aches/Pains").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy")));
