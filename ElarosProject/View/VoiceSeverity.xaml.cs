...
namespace ElarosProject.View
{
	...
	public partial class VoiceSeverity : ContentPage
	{
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                AssessmentModel symptom = new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Voice Change/Noisy Breathing").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy"));
