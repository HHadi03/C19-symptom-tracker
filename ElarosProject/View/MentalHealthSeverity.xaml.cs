...
namespace ElarosProject.View
{
	...
	public partial class MentalHealthSeverity : ContentPage
	{
        ...
        public MentalHealthSeverity ()
		{
			InitializeComponent ();
            inputValidatedTaskCompleted = new TaskCompletionSource<bool>();
        }
        private void MentalHealthPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                _assessmentVM.AssessmentResults.Add(new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Mental Health").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy")));
