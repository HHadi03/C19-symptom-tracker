...
namespace ElarosProject.View
{
	...
	public partial class ConcentrationSeverity : ContentPage
	{
        ...
        private void ConcentrationPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                AssessmentModel symptom = new AssessmentModel(currentUser.GetUserID(), "Concentration/Short term memory", selectedSeverity, DateTime.Now.ToString("dd/MM/yy"));
