...
namespace ElarosProject.View
{
	...
	public partial class CommunicationSeverity : ContentPage
	{
        ...
        public CommunicationSeverity ()
		{
			InitializeComponent ();
            inputValidatedTaskCompleted = new TaskCompletionSource<bool>();
        }
        private void CommunicationPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                _assessmentVM.AssessmentResults.Add(new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Communication").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy")));
