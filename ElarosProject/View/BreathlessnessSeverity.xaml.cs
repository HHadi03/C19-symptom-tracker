...
namespace ElarosProject.View
{
    ...
    public partial class BreathlessnessSeverity : ContentPage
    {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                AssessmentModel symptom = new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Breathlessness").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy"));
