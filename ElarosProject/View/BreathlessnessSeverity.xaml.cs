...
namespace ElarosProject.View
{
    ...
    public partial class BreathlessnessSeverity : ContentPage
    {
        ...
        public BreathlessnessSeverity()
        {
            InitializeComponent();
            inputValidatedTaskCompleted = new TaskCompletionSource<bool>();
        }

        private void BreathlessnessPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                _assessmentVM.AssessmentResults.Add(new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Breathlessness").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy")));
