...
namespace ElarosProject.View
{
	...
	public partial class ContinenceSeverity : ContentPage
	{
        ...
        public ContinenceSeverity ()
		{
			InitializeComponent ();
            inputValidatedTaskCompleted = new TaskCompletionSource<bool>();
		}

        private void ContinencePicker_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private async void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                _assessmentVM.AssessmentResults.Add(new AssessmentModel(currentUser, _assessmentVM.SymptomList.Where(s => s.GetSymptomName() == "Continence").FirstOrDefault(), selectedSeverity, DateTime.Now.ToString("dd/MM/yy")));
